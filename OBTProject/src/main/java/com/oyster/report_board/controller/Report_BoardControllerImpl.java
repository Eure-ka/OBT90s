...
public class Report_BoardControllerImpl implements Report_BoardController {
	...
	public ResponseEntity addNewArticle(MultipartHttpServletRequest multipartRequest, HttpServletResponse response)
		...
		try {
			...
			message += " location.href='" + multipartRequest.getContextPath() + "/board//report_boardlist.do'; ";
			message += " </script>";
			resEnt = new ResponseEntity(message, responseHeaders, HttpStatus.CREATED);
			...
			message += " location.href='" + multipartRequest.getContextPath() + "/board/report_boardForm.do'; ";
			message += " </script>";
			resEnt = new ResponseEntity(message, responseHeaders, HttpStatus.CREATED);
			e.printStackTrace();
		}
