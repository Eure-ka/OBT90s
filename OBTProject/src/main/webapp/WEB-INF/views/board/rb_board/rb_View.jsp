...
function fn_recommend_article(url,rb_number,isLogin ){
    ...
    $("#btnRecommend").click(function(){
       if(confirm("해당 글을 추천하시겠습니까?")){
           document.form1.action="${contextPath}/board/rb_board/recommend.do";
...
<body>
			...
			<div class="col-md-3">
				<div class="form-group">
					<label for="writer">작성자</label> <input type="text"
						...
						id="writer" value="${articleMap.article.member_id}" readonly>
				</div>
			</div>
		...
		<div class="form-group" style="margin-left: 70px">
			<label for="content">글내용</label> <input type=text
				...
				value="${articleMap.article.rb_content}" name="rb_content"
