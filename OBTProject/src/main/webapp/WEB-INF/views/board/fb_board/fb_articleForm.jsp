...
<script type="text/javascript">
  ...
  function backToList(obj){
    obj.action="${contextPath}/fb_board/fb_listArticles.do";
    obj.submit();
  }
...
<h1 style="text-align:center">글쓰기</h1>
  <form name="articleForm" method="post" action="${contextPath}/board/fb_board/addNewArticle.do" >
<!--   enctype="multipart/form-data" -->
    <table border="1" align="center">
      <tr>
         <td align="right"> 작성자</td>
         <td colspan=2  align="left"><input type="text" size="20" maxlength="100"  name="member_id" value="${memberInfo.name}" readonly /> </td>
         </tr>
        <tr>
            <td align="right">글제목: </td>
            <td colspan="2"><input type="text" size="67"  maxlength="500" name="fb_title" /></td>
       </tr>
          <tr>
            <td align="right" valign="top"><br>글내용: </td>
            <td colspan=2><textarea name="fb_content" rows="10" cols="65" maxlength="4000"></textarea> </td>
     </tr>
     <!-- <tr>
