...
<body>
	...
	<form name="articleForm" method="post"
		action="${contextPath}/board/fb_board/modarticle.do">
		<table border="1" align="center">
			...
			<tr>
				...
				<td colspan=2><textarea name="fb_content" rows="10" cols="65"
						maxlength="4000"></textarea></td>
			</tr>
			<input type="text" name="fb_number" value="${fb_number}" hidden />
			<!-- <tr>
