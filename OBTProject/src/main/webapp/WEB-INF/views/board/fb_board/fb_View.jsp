...
<body>
   <form name="frmArticle" method="post" action="${contextPath}/board/fb_board/fb_View.do">
      ...
      <div class="form-group" style="margin-right: 70px">
         <label for="title">글제목 <input type=text name="fb_title"
            value="${articleMap.article.fb_title}" disabled />
      </div>

      <div class="form-group" style="margin-left: 70px">
         <label for="content">글내용</label>
         <input type=text class="form-control" style="width:950px; height:500px" value="${articleMap.article.fb_content}" name="fb_content"
            ...
            <c:forEach var="item" items="${articleMap.imageFileList}"
               ...
               <tr>
                  ...
                  <td><input type="hidden" name="originalFileName"
                     ...
                     src="${contextPath}/download.do?fb_number=${articleMap.article.fb_number}&imageFileName=${item.imageFileName}"
  ...
  <tr  id="tr_btn"    >
   <td colspan="2" align="center">
       <c:if test="${memberInfo.member_id == articleMap.article.member_id}"> 
	      <input type=button value="수정하기" class="btn btn-info btn-sm" onClick="fn_modify_article('${contextPath}/board/fb_board/fb_articlemodForm.do',${articleMap.article.fb_number})">
	      <input type=button value="삭제하기" class="btn btn-danger btn-sm" onClick="fn_remove_article('${contextPath}/board/fb_board/removefreeboard.do' , ${articleMap.article.fb_number})">
	    </c:if>
