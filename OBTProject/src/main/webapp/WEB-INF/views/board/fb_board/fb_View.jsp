  ...
  <tr  id="tr_btn"    >
   <td colspan="2" align="center">
       <c:if test="${memberInfo.member_id == articleMap.article.member_id}"> 
	      <input type=button value="수정하기" onClick="fn_modify_article('${contextPath}/board/fb_board/fb_articlemodForm.do',${articleMap.article.fb_number})">
	      <input type=button value="삭제하기" onClick="fn_remove_article('${contextPath}/board/fb_board/removefreeboard.do' , ${articleMap.article.fb_number})">
	    </c:if>
