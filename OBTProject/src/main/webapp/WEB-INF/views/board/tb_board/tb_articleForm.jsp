...
<script type="text/javascript">
  ...
  function backToList(obj){
    obj.action="${contextPath}/tb_board/tb_listArticles.do";
    obj.submit();
  }
...
<h1 style="text-align:center">글쓰기</h1>
  <form name="articleForm" method="post" action="${contextPath}/tb_board/addNewArticle.do" >
    ...
    <table border="1" align="center">
      <tr>
        ...
        <tr>
            ...
            <td colspan="2"><input type="text" size="67"  maxlength="500" name="tb_title" /></td>
       </tr>
          <tr>
            <td align="right" valign="top"><br>글내용: </td>
            <td colspan=2><textarea name="tb_content" rows="10" cols="65" maxlength="4000"></textarea> </td>
     </tr>
     <!-- <tr>
