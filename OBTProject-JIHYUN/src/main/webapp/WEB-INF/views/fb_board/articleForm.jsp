...
<script type="text/javascript">
  ...
  function fn_addFile(){
     ...
     $("#d_file").append("<tr>"+"<td>"+"<input type='file' name='file"+cnt+"' onchange='readURL(this);' /></td>" + "<td><img class='preview"+cnt+"' scr='#' width=200 height=200/></td>"+"</tr>");
  }  
	...
	<form name="articleForm" method="post"
		...
		<table border="1" align="center">
			<tr>
				...
				<!-- submit할때 같이가게 할라면 readonly로 처리해야됨 -->
			</tr>
			<tr>
